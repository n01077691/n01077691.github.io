...
<body>
<p>This is jsp to select all courses < than 100</p>
  <%
	...
	try {
	  ...
	  String stringQuery = 
("SELECT course_no, description  FROM course WHERE course_no < 100");
      ...
      out.println("Course_NO , Description <br>"); 
      while(rset.next())
         out.println(rset.getString("Course_no") + ", " + rset.getString(2) + "<br>" );
      // 6. Close statement
      preState.close();
    }
